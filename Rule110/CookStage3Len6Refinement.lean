...
/-- Nonempty C3′′: L=6 n=1 uses theorem; all other nonempty cases use global induction. -/
theorem cook_cts_eval_sim_data_cones_origin_nonempty (cts : CyclicTagSystem) (n : ℕ)
  ...
  · exact cook_cts_eval_sim_data_cones_origin cts n w₀ idx₀
...
/-- **Refined C3′′ split:** empty post-word theorem; L=6 n=1 theorem; other nonempty → induction. -/
